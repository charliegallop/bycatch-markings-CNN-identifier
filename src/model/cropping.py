...
from config import TEST_DIR, EVAL_DIR, VAL_DIR, MASTER_MARKINGS_DIR,  MARKINGS_DIR, TRAIN_DIR, FINAL_PREDS_DIR
    ...
    def get_cropped_image(self, image_path):
            ...
            if (self.crop):
                if (len(box_to_crop) != 0):
                    ...
                    copy_to = os.path.join(FINAL_PREDS_DIR, 'gt')
