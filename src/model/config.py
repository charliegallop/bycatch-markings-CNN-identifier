...
MODEL_LIST = ["mobilenet", "resnet", "mobilenet_320"]
TRAIN_FOR_LIST = ["dolphin", "markings", "all"]
BACTH_SIZE = 64
EPOCHS = 3
...
BATCH_SIZE = 6 # increase / decrease according to GPU memory
RESIZE_TO = 720
...
CLASSES_MARKINGS = ['background', 'impression', 'fin_slice', 'amputation', 'notch']
